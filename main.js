...
var sports = []
sports.push('volleyball','basketball','football','soccer')
document.getElementById("q1").innerHTML = sports
...
document.getElementById('q2').innerHTML = sports
...
document.getElementById('q3').innerHTML = sports;
...
sports.unshift('hockey');
sports.splice(1,2);
sports.splice(2,0,'tennis','badminton');

document.getElementById('q4').innerHTML = sports

// 5. Log to the console: 'The current length of the array is....' using the .length method

document.getElementById('q5').innerHTML = "The length of the array is " + sports.length;
...
things[2] = 'keyboard'
var allthethings = things.join();

document.getElementById('q7').innerHTML = allthethings;

// 8. Remove the first item.

var somethings = things.shift();

document.getElementById('q8a').innerHTML = "Deleted: " + somethings;
...
// NAF comment: if use document.getElementById('q18').innerHTML = sortingNumbers.sort();
// the numbers do not sort correctly (2,300,5,55,77,98). Only uses the first
// digit of each value to do the sorting. 
